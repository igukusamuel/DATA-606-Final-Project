...
I saved the data as a csv file in my local drive and uploaded the output into my github repository for ease of accessibility, 
and to ensure that anyone running my file has access to it.
